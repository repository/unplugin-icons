...
var _chunkANMHZKV5js = require('./chunk-ANMHZKV5.js');
...
function nuxt_default(options = {}, nuxt) {
  ...
  nuxtApp.hook("webpack:config", (configs) => {
    configs.forEach((config) => {
      ...
      config.plugins.unshift(_chunkANMHZKV5js.src_default.webpack(options));
    });
  });
  nuxtApp.hook("vite:extend", async (vite) => {
    vite.config.plugins = vite.config.plugins || [];
    vite.config.plugins.push(_chunkANMHZKV5js.src_default.vite(options));
  });
}
